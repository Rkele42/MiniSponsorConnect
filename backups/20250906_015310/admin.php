  ...
  <div class="card">
    ...
    <?php foreach($listings as $l): ?>
      <div class="row" style="gap:8px;flex-wrap:wrap;margin:.25rem 0">
        ...
        <span class="badge">Durum: <?=htmlspecialchars(rkd_tr_status($l["status"]))?></span>
        <form method="post" class="row" style="gap:6px">
...
<?php foreach($orders as $o): ?>
      <div class="row" style="gap:8px;flex-wrap:wrap;margin:.25rem 0">
        ...
        <span class="badge">Durum: <?=htmlspecialchars(rkd_tr_status($o["status"]))?></span>
      </div>
      <div style="height:1px;background:#1f2937;margin:6px 0"></div>
    <?php endforeach; ?>
  </div>
  ...
  <div class="card">
    ...
    <?php foreach($topups as $t): ?>
      <div class="row" style="gap:8px;flex-wrap:wrap;margin:.25rem 0">
        ...
        <span class="badge">durum: <?=htmlspecialchars(rkd_tr_status($t["status"]))?></span>
      </div>
